...
public class OrdemServicoFuncionarioService {
	...
	public Pair<Integer, List<OrdemServicoFuncionario>> getOrdensAllEmployeesCurrentMonth() {
		...
		List<String> listOfEmployees = Arrays.asList("matheus", "elias", "geronildo", "thalisson","rayssa","ruan","marcos", "Mario Marques" , "elias padilha", "geronildo reis"); // TODO retrieve as
																									// checkbox in final
																									// app
